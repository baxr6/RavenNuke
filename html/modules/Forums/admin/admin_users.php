...
if ( $mode == 'edit' || $mode == 'save' && ( isset($_POST['username']) || isset($_GET[POST_USERS_URL]) || isset( $_POST[POST_USERS_URL]) ) )
{
		...
		$username = ( !empty($_POST['username']) ) ? phpbb_clean_username($_POST['username']) : '';
                $email = ( !empty($_POST['email']) ) ? trim(strip_tags(htmlspecialchars( $_POST['email'] , ENT_COMPAT ) )) : '';

                $password = ( !empty($_POST['password']) ) ? trim(strip_tags(htmlspecialchars( $_POST['password'] , ENT_COMPAT) )) : '';
                $password_confirm = ( !empty($_POST['password_confirm']) ) ? trim(strip_tags(htmlspecialchars( $_POST['password_confirm'] , ENT_COMPAT) )) : '';
        ...
        if( isset($_POST['avatargallery']) && !$error )
        {
                if( !$error )
                {
                        ...
                        {
                                $category = htmlspecialchars($_POST['avatarcategory'], ENT_COMPAT);
                        }
                        else
                        {
