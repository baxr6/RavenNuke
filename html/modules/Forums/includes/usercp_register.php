        ...
        $mode == 'register' )
{
        ...
        if ( $mode == 'editprofile' )
        {
                ...
                $current_email = trim(htmlspecialchars($_POST['current_email'], ENT_COMPAT));
        }
	...
	$strip_var_list = array('email' => 'email', 'icq' => 'icq', 'aim' => 'aim', 'msn' => 'msn', 'yim' => 'yim', 'website' => 'website', 'location' => 'location', 'occupation' => 'occupation', 'interests' => 'interests', 'confirm_code' => 'confirm_code');
        ...
        while( list($var, $param) = @each($strip_var_list) )
        {
                ...
                {
                        $$var = trim(htmlspecialchars($_POST[$param], ENT_COMPAT));
                }
        }
	...
	$sid = (isset($_POST['sid'])) ? $_POST['sid'] : 0;
        ...
        if ( !empty($_POST['language']) )
        {
                ...
                {
                        $user_lang = htmlspecialchars($_POST['language'], ENT_COMPAT);
                }
                else
                {
                        $error = true;
	...
	$board_config['default_dateformat'] = $row['config_value'];
        $user_dateformat = ( !empty($_POST['dateformat']) ) ? trim(htmlspecialchars($_POST['dateformat'], ENT_COMPAT)) : $board_config['default_dateformat'];

        $user_avatar_local = ( isset($_POST['avatarselect']) && !empty($_POST['submitavatar']) && $board_config['allow_avatar_local'] ) ? htmlspecialchars($_POST['avatarselect'], ENT_COMPAT) : ( ( isset($_POST['avatarlocal'])  ) ? htmlspecialchars($_POST['avatarlocal'], ENT_COMPAT) : '' );
        $user_avatar_category = ( isset($_POST['avatarcatname']) && $board_config['allow_avatar_local'] ) ? htmlspecialchars($_POST['avatarcatname'], ENT_COMPAT) : '' ;

        $user_avatar_remoteurl = ( !empty($_POST['avatarremoteurl']) ) ? trim(htmlspecialchars($_POST['avatarremoteurl'], ENT_COMPAT)) : '';
...
if ( isset($_POST['submit']) )
{
	...
	if ($board_config['enable_confirm'] && $mode == 'register')
	{
		...
		{
			$confirm_id = htmlspecialchars($_POST['confirm_id'], ENT_COMPAT);
...
if( isset($_POST['avatargallery']) && !$error )
{
	...
	$avatar_category = ( !empty($_POST['avatarcategory']) ) ? htmlspecialchars($_POST['avatarcategory'], ENT_COMPAT) : '';
