...
if (!empty($forum_moderators[$forum_id]) && is_array($forum_moderators[$forum_id])) {
    $moderator_count = count($forum_moderators[$forum_id]);
    $l_moderators = ($moderator_count === 1) ? $lang['Moderator'] : $lang['Moderators'];
