...
define('_DELETEINFO','Delete (Deletes <span class="thick italic">broken link</span> and <span class="thick italic">requests</span> for a given link)');
...
define('_IGNOREINFO','Ignore (Deletes all <span class="thick italic">requests</span> for a given link)');
